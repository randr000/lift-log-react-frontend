...
export const appReducer = (state, action) => {
    ...
    switch(type) {
        ...
        case APP_ACTION_TYPES.SIGN_IN_UNSUCCESSFUL:
            return {...state, signInError: payload, signedIn: false};
        ...
        case APP_ACTION_TYPES.SIGN_UP_UNSUCCESSFUL:
            return {...state, signUpError: payload, signedIn: false};
        ...
        case APP_ACTION_TYPES.TOGGLE_PASSWORD_RESET_MODAL:
            return {...state, showPasswordResetModal: payload};
        case APP_ACTION_TYPES.TOGGLE_SHOW_OFF_CANVAS:
